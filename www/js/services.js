...
.factory('contentService', function ($resource,$localstorage) {
        ...
        return {
            listCatalogs: function () {
                ...
                // if(catalogs == null){
                    catalogs = $resource('http://evncare.bigpay.vn/content/icare/catalogs').query();
            ...
            listContents: function (id) {
                contents = $resource('http://evncare.bigpay.vn/content/icare/contents/' + id + '/' + $localstorage.getObject('user').user_name).query();
            ...
            getContent: function (catalogId, Id) {
                ...
                return $resource('http://evncare.bigpay.vn/content/icare/' + catalogId +'/' + Id).get();
            },
            ...
            Getpower: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/getpower'
                + '/'
                + user_name
                +'?fselect_date='
                + searchdata.date
            ...
            Getmeterrecord: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/getmeterrecord'
                + '/'
                + user_name
                +'?fselect_date='
                + searchdata.date
            ...
            Getmeter: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/getmeter'
                + '/'
                + user_name
                +'?fselect_date='
                + searchdata.date
            ...
            Getinvoice: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/getinvoice'
                + '/'
                + user_name
                +'?fselect_date='
                + searchdata.date
             ...
             Getprice: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/getprice'
                + '/'
                + user_name
                +'?type='
            ...
            GetChar: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/getmeterstatis'
                + '/'
                + user_name
                +'?fyear='
                + searchdata.year
             ...
             GetCashier: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/cashiers'
                + '/'
                + user_name
                +'?latitude='
                + searchdata.lat
             ...
             GetContract: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/invoices'
                + '/'
                + user_name
                +'?page_index='
            ...
            Getinvoices: function(searchdata){
             ...
             GetCregister: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/cregister'
                + '/'
                + user_name
                +'?fullname='
            ...
            GetEregister: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/eregister'
                + '/'
                + user_name
                +'?enterpriseName='
                + searchdata.e_name
            ...
            Getintro: function(){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/intro'
                + '/'
                + user_name
                ).query();
                return contents;
            ...
            GetCC: function(){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/cc'
                + '/'
                + user_name
                ).query();
                return contents;
            ...
            GetNewscategories: function(){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/newscategories'
                + '/'
                + user_name
                ).query();
                return contents;
            ...
            GetNews: function(searchdata){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/news'
                + '/'
                + user_name
                +'?id='
                + searchdata.id
            ...
            GetNewdetail: function(id){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/newdetail'
                + '/'
                + user_name
                +'?id='
                + id
            ...
            Getfaq: function(){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/faq'
                + '/'
                + user_name
                ).query();
                return contents;
            ...
            Getrating: function(){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/ratingservices'
                + '/'
                + user_name
                ).query();
                return contents;
            ...
            Getratingdetail: function(id){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/quiz'
                + '/'
                + user_name
                + '?id='
                + id
            ...
            Putrating: function(quiz){
                ...
                contents =  $resource('http://evncare.bigpay.vn/content/icare/putquiz'
                + '/'
                + user_name
                + '?quiz='
                + quiz
    ...
    .factory('apiService', function ($http) {
        return {
            postLogin: function (username, password) {
                return $http.get('http://evncare.bigpay.vn/id/login/icare?username=' + username + '&password=' + password);
            },
